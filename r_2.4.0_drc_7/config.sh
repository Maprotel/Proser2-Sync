...
tar -xvf assets.tar -C /var/www/html
...
cp -f config/env.js  /var/www/html/proser_reports/assets-main/
cp -f config/hostInfo  /var/www/html/proser_reports/.hostInfo


## Main
cp -f config/env.js  /var/www/html/proser_reports/dist/assets-main/
