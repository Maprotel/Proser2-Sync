...
async function updateRealCurrentBreaks ( start_date, table, datefield ) {
  return new Promise( ( resolve, reject ) => {
    ...
    WHERE 
    rca_agent_datetime_login is not null 
    and 
    rca_agent_datetime_logout is not null;
    `
...
// npx babel-node src/sync/etl/transform/real/real-agents/transform_realagents.js
// transformRealAgents( incoming_date );
