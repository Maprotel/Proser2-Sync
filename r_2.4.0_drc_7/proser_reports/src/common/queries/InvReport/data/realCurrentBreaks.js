...
-- SUPERVISOR
${objectToJsonSqlQuery(userSelection.supervisor, "hca_agent_people_json")}

-- SCHEDULE
${objectToJsonSqlQuery(userSelection.client, "hca_agent_schedule_json")}

-- ROLE
${objectToJsonSqlQuery(userSelection.client, "hca_agent_role_json")}
