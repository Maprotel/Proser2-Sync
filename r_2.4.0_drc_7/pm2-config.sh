...
pm2 kill
# SERVERS
pm2 start --name SERVER-SERVER ./src/server/server.js --interpreter ./node_modules/.bin/babel-node
pm2 start --name SERVER-SYSTEM ./src/server/server.js --interpreter ./node_modules/.bin/babel-node

# SYNC
pm2 start --name SYNC-MAIN ./src/sync/etl/load/load_main.js --interpreter ./node_modules/.bin/babel-node
